...
```
Note: before deploying to XinFin testnet, make sure you have XDC in the wallet. If not, get free at [https://faucet_testnet.XinFin.org](https://faucet_testnet.XinFin.org)
