                    ...
                    <b-form-group
                        ...
                        <b-input-group>
                            <b-form-select
                                ...
                                <option value="testnet">XinFin Testnet</option>
                                <option value="custom">Custom Network</option>
                            </b-form-select>
                            <small
                                v-if="provider === 'testnet'"
                                class="form-text text-muted">Using node at https://testnet.XinFin.com.</small>
                        </b-input-group>
                    </b-form-group>
                    <b-form-group
                ...
                <ul class="XDC-list list-unstyled">
                    <li class="XDC-list__item">
                        ...
                        <p class="XDC-list__text">
                            <a :href="`https://explorer-testnet.XinFin.com/address/${address}`">
                                {{ address }}</a>
                            <span>Address</span>
                        </p>
                    </li>
